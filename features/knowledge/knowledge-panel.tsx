...
export function KnowledgePanel({
  ...
  const [testHistories, setTestHistories] = useState(initialHistories);
  ...
  const handleSaveVerdict = () => {
    ...
    setTestHistories((prev) => [entry, ...prev]);
  };
      ...
      <div className="knowledge-grid">
        ...
        <section className="panel panel--main">
          ...
          <div className="knowledge-form">
            ...
            <label className="field">
              <span className="field__label">문서 구분 *</span>
              <select
            ...
            <label className="field">
              <span className="field__label">테스트 대상 문서 *</span>
              <select
                className="field__input"
        ...
        <section className="panel panel--main">
          ...
          <p className="panel__caption">테스트 응답 결과를 확인하고 판정을 기록합니다.</p>

          {queryState === "IDLE" && (
            <div className="knowledge-result-empty">조회 조건을 입력하고 조회 버튼을 눌러 주세요.</div>
          )}
          {queryState === "LOADING" && (
            <div className="knowledge-result-empty">조회 중입니다.</div>
          )}
          {queryState === "EMPTY" && (
            <div className="knowledge-result-empty">선택한 문서에서 일치하는 답변이 없습니다.</div>
          )}
          {queryState === "ERROR" && (
            <div className="knowledge-result-empty">조회에 실패했습니다.</div>
          )}
